...
function Footer() {
  return (
    <nav className="!bg-white-200 my-4 first-line:font-sans text-center">
      <div className="flex space-x-40 text-lg px-48 pb-4">
        <div className='text-left space-x-3'>
          <p className='text-black font-bold pb-2 text-center'>
            Products & Services
          </p>
          <div className='flex space-x-5'>
            <div>
              <a href="" className='text-base hover:text-slate-400'>
                PDF data extraction
              </a><br></br>
              <a href="" className='text-base hover:text-slate-400'>
                And many more
      ...
      <a href=''> 
        &#169;2023 Copyright: website.com
      </a>
      {/* Above will link to Home Page */}
    </nav>
  );
}
